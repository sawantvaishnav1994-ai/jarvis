...
const allowed:Record<State,readonly State[]>={
 REQUESTED:["VALIDATED","FAILED"], VALIDATED:["AUTHORIZED","FAILED"], AUTHORIZED:["SIMULATED","DISPATCHING","VERIFYING","RECONCILING","FAILED"], SIMULATED:[], APPROVAL_REQUIRED:["APPROVED","FAILED"], APPROVED:["DISPATCHING","FAILED"], DISPATCHING:["RUNNING","FAILED"], RUNNING:["SUCCEEDED","FAILED","CANCEL_REQUESTED","TIMED_OUT","UNKNOWN_OUTCOME"], SUCCEEDED:["VERIFYING"], FAILED:[], CANCEL_REQUESTED:["CANCELLED","UNKNOWN_OUTCOME"], CANCELLED:[], TIMED_OUT:["UNKNOWN_OUTCOME","FAILED"], UNKNOWN_OUTCOME:["RECONCILING"], VERIFYING:["VERIFIED","FAILED"], VERIFIED:[], RECONCILING:["RECONCILED","FAILED"], RECONCILED:[], ROLLED_BACK:[]
};
