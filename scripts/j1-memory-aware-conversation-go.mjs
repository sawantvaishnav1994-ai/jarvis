...
try {
    ...
    const checks = {
        ...
        N:
            roadmap.includes("J1.5 remains authoritative for durable conversation history") &&
            roadmap.includes("Durable conversation history remains J1.5"),
        O:
            unit.includes("J1.6 memory-aware conversation") &&
            security.includes("J1.6 memory-aware conversation security boundaries"),
        P: roadmap.includes("J1.7 tool-aware conversation is not part of J1.6"),
        Q: roadmap.includes("J1.8 approval-aware execution is not part of J1.6"),
        R:
